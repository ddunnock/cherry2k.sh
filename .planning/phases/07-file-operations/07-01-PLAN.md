...
must_haves:
  truths:
    - "File paths mentioned in user messages are detected"
    - "Detected files are read and their content is accessible"
    - "Large files trigger size assessment before reading"
