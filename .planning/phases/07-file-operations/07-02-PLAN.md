...
must_haves:
  truths:
    - "Unified diff is generated between old and new file content"
    - "Diff displays with +/- line coloring (green/red)"
    - "New file creation shows preview, not diff format"
    - "User can approve, reject, or edit proposed changes"
    - "Edit option opens $EDITOR and re-displays diff on save"
  artifacts:
